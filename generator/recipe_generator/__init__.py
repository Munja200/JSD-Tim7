...
# @generator('python', 'windows')
# def python_generate_windows(metamodel, model, output_path, overwrite, debug, **custom_args):
#     "Generator for generating windows from python descriptions"

#     output_file = get_output_filename(model.file_name, output_path, '*.rcp')
